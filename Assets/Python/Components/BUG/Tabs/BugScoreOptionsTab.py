...
class BugScoreOptionsTab(BugOptionsTab.BugOptionsTab):
	...
	def create(self, screen):
		...
		#Platy Scoreboard
		#screen.attachHSeparator(column, column + "platy")
		#left, space, center, right = self.addMultiColumnLayout(screen, column, 4, "platy")
		#self.addCheckbox(screen, left, "Scores__Platy")
		#self.addCheckbox(screen, right, "Scores__Platy")
	        #Platy Scoreboard
