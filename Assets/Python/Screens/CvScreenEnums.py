...
PEDIA_TECH = CivilopediaPageTypes.CIVILOPEDIA_PAGE_TECHNOLOGY + PEDIA_START
PEDIA_UNIT = CivilopediaPageTypes.CIVILOPEDIA_PAGE_UNIT + PEDIA_START
PEDIA_UNIT_COMPARISON = CivilopediaPageTypes.CIVILOPEDIA_PAGE_UNIT_COMPARISON + PEDIA_START
PEDIA_UNIT_CHART = CivilopediaPageTypes.CIVILOPEDIA_PAGE_UNIT_CLASS + PEDIA_START
PEDIA_UNIT_COMBAT = CivilopediaPageTypes.CIVILOPEDIA_PAGE_UNIT_COMBAT + PEDIA_START
PEDIA_UNIT_UPGRADE_CHART = CivilopediaPageTypes.CIVILOPEDIA_PAGE_UNIT_UPGRADE_CHART + PEDIA_START
PEDIA_PROMOTION = CivilopediaPageTypes.CIVILOPEDIA_PAGE_PROMOTION + PEDIA_START
PEDIA_PROMOTION_TREE = CivilopediaPageTypes.CIVILOPEDIA_PAGE_PROMOTION_TREE + PEDIA_START
PEDIA_PAGE_AID = CivilopediaPageTypes.CIVILOPEDIA_PAGE_AID + PEDIA_START
PEDIA_PAGE_DETRIMENT = CivilopediaPageTypes.CIVILOPEDIA_PAGE_DETRIMENT + PEDIA_START
PEDIA_BUILDING = CivilopediaPageTypes.CIVILOPEDIA_PAGE_BUILDING + PEDIA_START
PEDIA_BUILDING_COMPARISON = CivilopediaPageTypes.CIVILOPEDIA_PAGE_BUILDING_COMPARISON + PEDIA_START
PEDIA_BUILDING_CLASS = CivilopediaPageTypes.CIVILOPEDIA_PAGE_BUILDING_CLASS + PEDIA_START
PEDIA_WONDER = CivilopediaPageTypes.CIVILOPEDIA_PAGE_WONDER + PEDIA_START
PEDIA_PROJECT = CivilopediaPageTypes.CIVILOPEDIA_PAGE_PROJECT + PEDIA_START
PEDIA_CIVILIZATION = CivilopediaPageTypes.CIVILOPEDIA_PAGE_CIVILIZATION + PEDIA_START
...
PEDIA_ERA = CivilopediaPageTypes.CIVILOPEDIA_PAGE_ERA + PEDIA_START
...
PEDIA_WORLD = CivilopediaPageTypes.CIVILOPEDIA_PAGE_WORLD + PEDIA_START
PEDIA_ROUTE = CivilopediaPageTypes.CIVILOPEDIA_PAGE_ROUTE + PEDIA_START
PEDIA_HANDICAP = CivilopediaPageTypes.CIVILOPEDIA_PAGE_HANDICAP + PEDIA_START
PEDIA_INTRODUCTION = CivilopediaPageTypes.CIVILOPEDIA_PAGE_INTRODUCTION + PEDIA_START
PEDIA_CONCEPT = CivilopediaPageTypes.CIVILOPEDIA_PAGE_CONCEPT + PEDIA_START
PEDIA_CONCEPT_NEW = PEDIA_CONCEPT
PEDIA_HINTS = CivilopediaPageTypes.CIVILOPEDIA_PAGE_HINTS + PEDIA_START
PEDIA_PAGE_SHORTCUTS = CivilopediaPageTypes.CIVILOPEDIA_PAGE_SHORTCUTS + PEDIA_START
PEDIA_HISTORY = PEDIA_PAGE_SHORTCUTS+1#CivilopediaPageTypes.CIVILOPEDIA_PAGE_HISTORY + PEDIA_START
"""
