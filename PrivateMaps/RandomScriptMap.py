...
c_minStartAreaSize = [6, 6, 8, 8, 10, 10, 12]   # Default [6, 6, 8, 8, 10, 10]
c_spacePerCiv = [40, 50, 50, 75, 75, 90, 120]    # Default [40,50,50,75,75,90]
#
...
c_polar_lat_limit = [0.16, 0.16, 0.14, 0.14, 0.12, 0.12, 0.12]
...
class R_PangaeaMultilayeredFractal(CvMapGeneratorUtil.MultilayeredFractal):
    ...
    def generatePlotsByRegion(self, pangaea_type):
        ...
        sizevalues = {
			...
			WorldSizeTypes.WORLDSIZE_GIANT:     5
            }
