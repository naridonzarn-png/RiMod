...
class FeatureGenerator:
	...
	def __initFeatureTypes(self):
		...
		self.featureIsland = self.gc.getInfoTypeForString("FEATURE_ISLAND")
		self.featureIslandNorth = self.gc.getInfoTypeForString("FEATURE_ISLAND_NORTH")
		self.featureReef = self.gc.getInfoTypeForString("FEATURE_REEF")
...
class BonusBalancer:
	def __init__(self):
		...
		self.resourcesToBalance = ('BONUS_ALUMINUM', 'BONUS_COAL', 'BONUS_COPPER', 'BONUS_HORSE', 'BONUS_IRON', 'BONUS_OIL', 'BONUS_URANIUM', 'BONUS_SALTPETER')
