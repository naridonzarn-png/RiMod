...
class SevoPediaCivic:
	...
	def placeSpecial(self):
		...
		# TR - START
		# List was scrolling over the top of the header
		"""
		...
		screen.addMultilineText(listName, szSpecialText, self.X_SPECIAL+5, self.Y_SPECIAL+30, self.W_SPECIAL-10, self.H_SPECIAL-30, WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
		# TR - END
