...
class BugUnitNameOptionsTab(BugOptionsTab.BugOptionsTab):
	...
	def create(self, screen):
		...
		self.addTextEdit(screen, columnL, columnR, "UnitNaming__Combat_MOUNTED_LIGHT")
		self.addTextEdit(screen, columnL, columnR, "UnitNaming__Combat_NAVAL_SAILING_SHIP")		
		self.addTextEdit(screen, columnL, columnR, "UnitNaming__Combat_NAVAL_TORPEDO_BOAT")	
		self.addTextEdit(screen, columnL, columnR, "UnitNaming__Combat_NAVAL_DESTROYER")	
		self.addTextEdit(screen, columnL, columnR, "UnitNaming__Combat_NAVAL_CRUISER")	
		self.addTextEdit(screen, columnL, columnR, "UnitNaming__Combat_NAVAL_CAPITAL_SHIP")	
		self.addTextEdit(screen, columnL, columnR, "UnitNaming__Combat_NAVAL_CARRIER")	
		self.addTextEdit(screen, columnL, columnR, "UnitNaming__Combat_NAVAL_SUBMARINE")	