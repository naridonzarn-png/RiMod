...
class SevoPediaFeature:
	...
	def __init__(self, main):
		...
		self.H_SPECIAL_PANE = 165#self.top.B_PEDIA_PAGE - self.Y_SPECIAL_PANE

		self.X_HISTORY_PANE = self.X_ICON_PANE
		self.Y_HISTORY_PANE = 453
	...
	def placeHistory(self):
		...
		panelName = self.top.getNextWidgetName()
		screen.addPanel( panelName, localText.getText("Description", ()), "", True, True,
		...
		screen.addMultilineText( textName, gc.getFeatureInfo(self.iFeature).getCivilopedia(), self.X_HISTORY_PANE + 15, self.Y_HISTORY_PANE + 40,
		    self.W_HISTORY_PANE - (15 * 2), self.H_HISTORY_PANE - (15 * 2) - 30, WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
