...
Dynamic ={
	...
	"MASTER_DRAVIDIAN":[				[["ERA_INDUSTRIAL"],							
							["TXT_KEY_CIV_INDIA_VASSAL_IND_DESC", "KEY_SHORT", "", "KEY_SHORT", "KEY_ADJ", "gen", "2"]],

							[[""],
							["TXT_KEY_CIV_INDIA_VASSAL_DESC", "KEY_SHORT", "", "KEY_SHORT", "KEY_ADJ", "gen", "2"]],
				],				
			...
			if iPlayer > 0: 
				...
				if iCivCounter == 1:							## If it's the second civ of its type 
					...
					for iPlayerX in xrange(0,iPlayer):
						...
						if str(sCiv) == str(sCivX):
							iPlayerY = iPlayerX
							if gc.getTeam(pPlayerX.getTeam()).isAVassal():
								bVassal = True
